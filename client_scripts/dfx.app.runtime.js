var dfxSystemModules = ['ngRoute', 'ngMaterial', 'dfxGCC', 'dfxAppServices', 'nvd3'];
...
dfxAppRuntime.directive('dfxView', [ '$http', '$timeout', '$compile', 'dfxioPubSub', function($http, $timeout, $compile, dfxioPubSub) {
	return {
    	restrict: 'A',
        controller: function($scope, $element, $attrs) {
			var renderHtml = function() {
                $http.get( $attrs.dfxView + '/' + $attrs.dfxView + '_compiled.html' ).success(function(response) {
